...
public class KittehSprite extends Sprite {
    ...
    /** Move towards some target location. */
    public void move(double targetX, double targetY) {
         // get the angle from our current position to our target position.
         double angleTo = GameMath.angleTo(x,y,targetX,targetY);
         
         // compute our velocity
         double dx = speed * GameMath.cos(angleTo);
         double dy = -1*speed * GameMath.sin(angleTo);
    ...
    /** Move away some target location. */
    public void moveAway(double targetX, double targetY) {
         // get the angle from our current position to our target position.
         double angleAway = 180 + GameMath.angleTo(x,y,targetX,targetY);
         
         // compute our velocity
         double dx = speed * GameMath.cos(angleAway);
         double dy = -1*speed * GameMath.sin(angleAway);
